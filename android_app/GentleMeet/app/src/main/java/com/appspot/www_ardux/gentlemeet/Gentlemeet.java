...
public class Gentlemeet extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class Event {
     ...
     * @return the request
     */
    public CheckOut checkOut(java.lang.String id) throws java.io.IOException {
    ...
    public class CheckOut extends GentlemeetRequest<com.appspot.www_ardux.gentlemeet.model.ArduxApiMessagesCheckInOutMessage> {
       ...
       * @since 1.13
       */
      protected CheckOut(java.lang.String id) {
      ...
      public CheckOut setId(java.lang.String id) {
        this.id = id;
        return this;
      }
    ...
    /**
     * Mark an event as finished and set the actual end time as right now. Updates the Google Calendar
     * event accordingly.
     *
     ...
     * @return the request
     */
    public Finish finish(java.lang.String id) throws java.io.IOException {
    ...
    public class Finish extends GentlemeetRequest<com.appspot.www_ardux.gentlemeet.model.ArduxApiMessagesEventMessage> {
       ...
       * @since 1.13
       */
      protected Finish(java.lang.String id) {
      ...
      public Finish setId(java.lang.String id) {
        this.id = id;
        return this;
      }
  ...
  public class Events {
     ...
     * @return the request
     */
    public CheckIn checkIn(java.lang.String id) throws java.io.IOException {
    ...
    public class CheckIn extends GentlemeetRequest<com.appspot.www_ardux.gentlemeet.model.ArduxApiMessagesCheckInOutMessage> {
       ...
       * @since 1.13
       */
      protected CheckIn(java.lang.String id) {
        super(Gentlemeet.this, "POST", REST_PATH, null, com.appspot.www_ardux.gentlemeet.model.ArduxApiMessagesCheckInOutMessage.class);
        this.id = com.google.api.client.util.Preconditions.checkNotNull(id, "Required parameter id must be specified.");
      }
  ...
  public class Resource {
     ...
     * doesn't exists throws an exception. If calendar access is not granted throws an exception.
     *
     ...
     * @return the request
     */
    public EventCurrent eventCurrent(java.lang.String id) throws java.io.IOException {
    ...
    public class EventCurrent extends GentlemeetRequest<com.appspot.www_ardux.gentlemeet.model.ArduxApiMessagesEventMessage> {
       ...
       * resource doesn't exists throws an exception. If calendar access is not granted throws an
       * exception.
       *
       * Create a request for the method "resource.eventCurrent".
       *
       ...
       * @since 1.13
       */
      protected EventCurrent(java.lang.String id) {
      ...
      public EventCurrent setId(java.lang.String id) {
        this.id = id;
        return this;
      }
     ...
     *
     * Create a request for the method "resource.nextEventsToday".
     *
     * This request holds the parameters needed by the gentlemeet server.  After setting any optional
     * parameters, call the {@link NextEventsToday#execute()} method to invoke the remote operation.
     *
     * @param id
     * @return the request
     */
    public NextEventsToday nextEventsToday(java.lang.String id) throws java.io.IOException {
      NextEventsToday result = new NextEventsToday(id);
      initialize(result);
      return result;
    }

    public class NextEventsToday extends GentlemeetRequest<com.appspot.www_ardux.gentlemeet.model.ArduxApiMessagesEventsResponseMessage> {
       ...
       *
       * This request holds the parameters needed by the the gentlemeet server.  After setting any
       * optional parameters, call the {@link NextEventsToday#execute()} method to invoke the remote
       * operation. <p> {@link NextEventsToday#initialize(com.google.api.client.googleapis.services.Abst
       ...
       * @since 1.13
       */
      protected NextEventsToday(java.lang.String id) {
      ...
      @Override
      public NextEventsToday setAlt(java.lang.String alt) {
        return (NextEventsToday) super.setAlt(alt);
      }

      @Override
      public NextEventsToday setFields(java.lang.String fields) {
        return (NextEventsToday) super.setFields(fields);
      }

      @Override
      public NextEventsToday setKey(java.lang.String key) {
        return (NextEventsToday) super.setKey(key);
      }

      @Override
      public NextEventsToday setOauthToken(java.lang.String oauthToken) {
        return (NextEventsToday) super.setOauthToken(oauthToken);
      }

      @Override
      public NextEventsToday setPrettyPrint(java.lang.Boolean prettyPrint) {
        return (NextEventsToday) super.setPrettyPrint(prettyPrint);
      }

      @Override
      public NextEventsToday setQuotaUser(java.lang.String quotaUser) {
        return (NextEventsToday) super.setQuotaUser(quotaUser);
      }

      @Override
      public NextEventsToday setUserIp(java.lang.String userIp) {
        return (NextEventsToday) super.setUserIp(userIp);
      }
      ...
      public NextEventsToday setId(java.lang.String id) {
        this.id = id;
        return this;
      }

      @Override
      public NextEventsToday set(String parameterName, Object value) {
        return (NextEventsToday) super.set(parameterName, value);
      }
    }
    /**
     * Let an anonymous user book a resource in the moment, create a calendar event and checks the user
     * in. If the resource doesn't exists throws an exception. If there is an event happening throws an
     * exception.
     *
     ...
     * @return the request
     */
    public QuickAdd quickAdd(java.lang.String id) throws java.io.IOException {
    ...
    public class QuickAdd extends GentlemeetRequest<com.appspot.www_ardux.gentlemeet.model.ArduxApiMessagesEventMessage> {
      ...
      /**
       * Let an anonymous user book a resource in the moment, create a calendar event and checks the
       * user in. If the resource doesn't exists throws an exception. If there is an event happening
       * throws an exception.
       *
       * Create a request for the method "resource.quickAdd".
       *
       ...
       * @since 1.13
       */
      protected QuickAdd(java.lang.String id) {
        super(Gentlemeet.this, "POST", REST_PATH, null, com.appspot.www_ardux.gentlemeet.model.ArduxApiMessagesEventMessage.class);
        this.id = com.google.api.client.util.Preconditions.checkNotNull(id, "Required parameter id must be specified.");
      }
      ...
      public QuickAdd setId(java.lang.String id) {
        this.id = id;
        return this;
      }
